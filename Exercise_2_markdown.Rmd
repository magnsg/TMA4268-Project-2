...
```
As one can see the best linear svm model is with cost=5 and it has error=0.
...
```
Socondly we perform cross validation of the model in order to choose optimal  
